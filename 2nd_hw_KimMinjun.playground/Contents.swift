...
//
let pi : Double = 3.14
func printArea (_ a: Int , _ b: Int){
    print(a*b)
}
...
// ---------- Mark : function If문사용   ----------------
func checkLoginStatus (_ isLogin : Bool ,_ username : String?){
    if isLogin {
        if username == nil {
            print("알 수 없는 사용자")
        }else{
...
checkLoginStatus(true, "minjun")
checkLoginStatus(true, nil)
checkLoginStatus(false, "minjun")

print("---------------------")
// ---------- Mark : function guard문 사용  ----------------

func checkLoginnStatusGuard (_ isLogin : Bool , _ username : String?){
    guard isLogin else {
        print("로그인이 필요합니다.")
        return
    }
    guard let letusername = username else{
        print("알 수 없는 사용자입니다.")
        return
    }
    print(letusername)
...
checkLoginnStatusGuard(true, "minjun")
checkLoginnStatusGuard(true, nil)
checkLoginnStatusGuard(false, "minjun")
...
var names: [String] = ["Alice", "Bob", "Charlie"]
//var names : [String] = []
let firstOne = names.first ?? "NO name found"
print (firstOne)
print("---------------------")
...
if let optionalString1 = optionalString {
    print ("The string is:" + optionalString1)
}else{
...
func getOptionalString (_ input : String? ){
    guard let optionalpr = input else {
        print ("The string is nil.")
        return
    }
    print ("The string is:" + optionalpr)
}

getOptionalString(optionalString2)
