//
//  modalHeaderCell.swift
//  5th_hw_KimMinjun
//
//  Created by 김민준 on 5/3/24.
//
...
class modalHeaderCell : UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier : String?){
        super.init(style: style, reuseIdentifier: "modalHeader")
...
//            button.addTarget(self, action: #selector(ModalViewController.closeModal), for: .touchUpInside)
        ...
        NSLayoutConstraint.activate([
            ...
            mirrorButton.topAnchor.constraint(equalTo: contentView.topAnchor , constant: 8),
            mirrorButton.leadingAnchor.constraint(equalTo: contentView.leadingAnchor , constant: 295),
            mirrorButton.widthAnchor.constraint(equalToConstant: 28),
            mirrorButton.heightAnchor.constraint(equalToConstant: 28),
            
            
            xButton.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 8),
            xButton.leadingAnchor.constraint(equalTo: contentView.leadingAnchor , constant: 339),
